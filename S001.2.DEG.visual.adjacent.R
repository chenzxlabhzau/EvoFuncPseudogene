#adjacent
## wc -l *txt| grep txt | awk -F " " '{print $1"\t"$2}' > adjacent.DEG.number

library(ggplot2)
rm(list = ls())
a = read.csv("/home/qians/Pseudo/Result/Human/Savedata/DEG/adjacent/adjacent.DEG.number",
...
ggsave(p,filename = file.path("~/Pseudo/Result",Species,"Picture",paste0(Species,".number.DEG.adjacent.pdf")),
